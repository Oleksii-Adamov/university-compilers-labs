...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_RANGE_COUNT = 20,          // "#"
    TOK_ASSIGNMENT = 21,           // "="
    TOK_COMPOUND_ASSIGNMENT = 22,  // COMPOUND_ASSIGNMENT
    TOK_STATEMENT_SEPARATOR = 23,  // ";"
    TOK_EXPRESSION_SEPARATOR = 24, // ","
    TOK_LEFT_ROUND_BRACKET = 25,   // "("
    TOK_RIGHT_ROUND_BRACKET = 26,  // ")"
    TOK_LEFT_CURLY_BRACKET = 27,   // "{"
    TOK_RIGHT_CURLY_BRACKET = 28,  // "}"
    TOK_LEFT_SQUARE_BRACKET = 29,  // "["
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_RANGE_COUNT = 20,                      // "#"
        S_ASSIGNMENT = 21,                       // "="
        S_COMPOUND_ASSIGNMENT = 22,              // COMPOUND_ASSIGNMENT
        S_STATEMENT_SEPARATOR = 23,              // ";"
        S_EXPRESSION_SEPARATOR = 24,             // ","
        S_LEFT_ROUND_BRACKET = 25,               // "("
        S_RIGHT_ROUND_BRACKET = 26,              // ")"
        S_LEFT_CURLY_BRACKET = 27,               // "{"
        S_RIGHT_CURLY_BRACKET = 28,              // "}"
        S_LEFT_SQUARE_BRACKET = 29,              // "["
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ASSIGNMENT (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_ASSIGNMENT (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_COMPOUND_ASSIGNMENT (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_COMPOUND_ASSIGNMENT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_COMPOUND_ASSIGNMENT (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_COMPOUND_ASSIGNMENT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_EXPRESSION_SEPARATOR (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_EXPRESSION_SEPARATOR, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_EXPRESSION_SEPARATOR (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_EXPRESSION_SEPARATOR, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LEFT_SQUARE_BRACKET (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_LEFT_SQUARE_BRACKET, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LEFT_SQUARE_BRACKET (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_LEFT_SQUARE_BRACKET, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_SQUARE_BRACKET (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_RIGHT_SQUARE_BRACKET, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_RIGHT_SQUARE_BRACKET (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_RIGHT_SQUARE_BRACKET, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RANGE_SPECIFIER (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_RANGE_SPECIFIER, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_RANGE_SPECIFIER (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_RANGE_SPECIFIER, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_HALF_OPEN_RANGE_SPECIFIER (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_HALF_OPEN_RANGE_SPECIFIER, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_HALF_OPEN_RANGE_SPECIFIER (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_HALF_OPEN_RANGE_SPECIFIER, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_IF (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_THEN (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_THEN (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_ELSE (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_ELSE (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_VAR (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_VAR (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_CONST (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_CONST (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_WHILE (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_WHILE (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_DO (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_DO (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_FOR (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_FOR (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_IN (ASTNode* v, location_type l)
      {
      ...
      static
      symbol_type
      make_IN (const ASTNode*& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_ZIP (ASTNode* v, location_type l)
      {
        return symbol_type (token::TOK_ZIP, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ZIP (const ASTNode*& v, const location_type& l)
      {
        return symbol_type (token::TOK_ZIP, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
